...
namespace FlightSimulator.Model
{
    public class MainWinMod : BaseNotify, IMainWinModel
    {
        ...
        private volatile bool firstMessage;
        //CTOR
        ...
        public double Lon
        {
            set { if (this.lon != value) { this.lon = value; } /*NotifyPropertyChanged("Lon");*/ }
            get { return this.lon; }
        }

        public double Lat
        {
            set { if (this.lat != value) { this.lat = value; NotifyPropertyChanged("Lat"); } }
            get { return this.lat; }
        }
            ...
            new Thread(delegate ()
            {
                ...
                {   //set up connection for FlightGear to connect to...
                    ...
                    while (reader != null)
                    {
                        ...
                        if (firstMessage == true)   //ignore first message
                        {
                            firstMessage = false;
                            continue;
                        }
